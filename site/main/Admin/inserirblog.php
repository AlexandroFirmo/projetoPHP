...
<form class="form-horizontal col-xs-8 col-xs-push-2" action="?pg=inserirblogdb" method="post">
    ...
    <div class="form-group"> 
        ...
        <input class="form-control" id="subtitulo" name="conteudo" type="text" required="required"/>
    </div>
	<div class="form-group"> 
	...
	<div class="form-group"> 
        ...
        <input class="form-control" id="subtitulo" name="data" type="text" required="required"/>
    </div>
    <div class="form-group">
